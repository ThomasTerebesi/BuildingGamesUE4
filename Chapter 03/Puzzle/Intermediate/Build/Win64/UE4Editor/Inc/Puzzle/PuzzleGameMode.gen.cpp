...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APuzzleGameMode_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_APuzzleGameMode_Statics::StaticCppClassTypeInfo = {
		TCppClassTypeTraits<APuzzleGameMode>::IsAbstract,
	};
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_APuzzleGameMode_Statics::ClassParams = {
		...
		nullptr, 0,
		METADATA_PARAMS(Z_Construct_UClass_APuzzleGameMode_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_APuzzleGameMode_Statics::Class_MetaDataParams))
	};
	UClass* Z_Construct_UClass_APuzzleGameMode()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_APuzzleGameMode_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(APuzzleGameMode, 1184449833);
	static FCompiledInDefer Z_CompiledInDefer_UClass_APuzzleGameMode(Z_Construct_UClass_APuzzleGameMode, &APuzzleGameMode::StaticClass, TEXT("/Script/Puzzle"), TEXT("APuzzleGameMode"), false, nullptr, nullptr, nullptr);
